...
setup(
    name="Flask-WalletConnect",
    use_scm_version=True,
    setup_requires=["setuptools_scm"],
    description=(
        "Flask-WalletConnect: Flask plugin that allows integrating "
        "with a user's wallet over WalletConnect"
    ),
    ...
    py_modules=["flask_walletconnect"],
    license="Apache-2.0",
    zip_safe=False,
    keywords="ethereum",
    packages=find_packages(exclude=["tests", "tests.*"]),
    package_data={"flask_walletconnect": ["py.typed"]},
    classifiers=[
